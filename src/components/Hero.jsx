          ...
          <div className="z-10 text-center lg:text-left">
            ...
            >
              <h1 className="mb-6">
                ...
                <span className="block text-primary italic">Sai Krishna</span>
              </h1>
              
              <p className="text-lg md:text-xl text-text-secondary leading-relaxed max-w-xl mx-auto lg:mx-0 mb-10">
                Senior Data Analyst with 4+ years of experience in data analysis, data reporting, and BI solutions. Expertise in SQL, Python, and Power BI across financial and enterprise environments.
              </p>
