  ...
  const projects = [
    {
      ...
      tag: "Snowflake | SQL | Power BI",
      image: "/assets/project1.png",
      desc: "Built a centralized reporting dataset in Snowflake integrating finance and operations data, improving KPI tracking accuracy by 25%."
    },
    {
      num: "02",
      title: "Customer & Product Analytics",
      tag: "Python | SQL | Behavioral Analysis",
      image: "/assets/project2.png",
      desc: "Analyzed user activity using cohort and funnel analysis to improve engagement visibility by 20% and identify behavior patterns."
    },
    {
      num: "03",
      title: "Reporting Automation Framework",
      tag: "Azure Databricks | dbt | ELT",
      image: "/assets/project3.png",
      desc: "Transformed raw business data into structured datasets leveraging big data processing in Databricks, reducing latency by 30%."
    }
  ];
