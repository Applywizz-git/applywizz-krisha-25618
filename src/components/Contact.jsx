                ...
                <div className="space-y-10">
                  <div className="flex gap-8 group">
                    ...
                    <div>
                      ...
                      <a href="mailto:saikrishna64a@gmail.com" className="text-xl font-bold text-white hover:text-primary transition-colors">saikrishna64a@gmail.com</a>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-8 group">
                    ...
                    <div>
                      ...
                      <a href="tel:+14752678124" className="text-xl font-bold text-white hover:text-secondary transition-colors">+1 (475) 267-8124</a>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-8 group">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-white transition-colors">Lincoln, NE</p>
                    </div>
                  </div>
                </div>

                <div className="p-8 rounded-[40px] bg-primary/5 border border-primary/10 italic text-sm text-text-secondary">
                   "Available for senior data analysis and analytics engineering roles."
                </div>
             </div>
          </div>
